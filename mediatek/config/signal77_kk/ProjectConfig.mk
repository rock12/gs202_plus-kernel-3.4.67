...
# User space image sensor driver. Define  project used all image sensors. The value is combination of CUSTOM_HAL_MAIN_IMGSENSOR, CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR, CUSTOM_HAL_SUB_IMGSENSOR, and CUSTOM_HAL_SUB_BACKUP_IMGSENSOR    ov5647_raw
CUSTOM_HAL_IMGSENSOR=mt9p017_raw gc0329_yuv
...
CUSTOM_HAL_MAIN_IMGSENSOR=mt9p017_raw
...
CUSTOM_HAL_LENS=mt9p017af dummy_lens

# M-sensor hal layer library including daemon
CUSTOM_HAL_MSENSORLIB=mag3110
...
CUSTOM_KERNEL_ACCELEROMETER=mma8453q
...
CUSTOM_KERNEL_LENS=mt9p017af dummy_lens
...
CUSTOM_KERNEL_LCM=otm8009a_dsi

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=otm8009a_dsi
